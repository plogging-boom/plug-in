...
class GoogleMapProvider with ChangeNotifier {
  ...
  void stopPlugIn() {
    ...
    addMarker(35.13344903366917, 129.0946524222071);
  ...
  void startPlugIn() {
    ...
    addMarker(35.133682700701776, 129.0962467935405);
    Stream.periodic(Duration(seconds: 3), (int x) => x)
        .take(18)
        .listen((int x) {
      print(testPoints[x]);
